            ...
            <form class="form-horizontal" action="klasifikasi_tambah.php" method="post" role="form">
                <div class="panel panel-default">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-right">Jenis Hewan:</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-right">Tangibility/Kenyataan:</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-right">Empathy/Empati:</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-right">Reliability/Keandalan:</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-right">Responsiveness/Ketanggapan:</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label text-right">Assurance/Kepastian:</label>
                        <div class="col-sm-3">
