...
<!-- Body -->
		...
		<!-- Page title -->
			...
			<div class="panel panel-default">
				<div class="panel-heading" align="right"><h6 class="panel-title"><i class="fa fa-male"></i> Data Hewan</h6>
				<a href="mahasiswa_tambah.php"><input type="submit" value="Tambah Data Hewan" class="btn btn-info"></a>
				</div>
				<div class="datatable">
