		...
		<!-- Page title -->
			...
			<form class="form-horizontal" action="mahasiswa_tambah.php" method="post" role="form">
                <div class="panel panel-default">
                    <div class="panel-heading"><h6 class="panel-title">Data Pasien Hewan</h6></div>
                    <div class="panel-body">

                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">Id Pasien Hewan:</label>
                            <div class="col-sm-10">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label text-right">Nama Pasien Hewan:</label>
                            <div class="col-sm-10">
